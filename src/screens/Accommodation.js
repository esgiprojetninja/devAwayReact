                        ...
                        <View style={styles.containerInformations}>
                            ...
                            <View style={{ flex: 1, marginTop: 20, marginRight: 30 }}>
                                <View style={styles.headerIconItems}>
                                    ...
                                    <Text style={styles.headerIconOneItem}><Icon name="space-shuttle" size={16} color="black" /> {this.state.accommodation.nbBedroom + this.state.accommodation.nbBathroom} rooms</Text>
                                </View>
                                <View style={styles.headerIconItems}>
                            ...
                            <View>
                                <Text>Hello</Text>
                                <View>
                                    <Icon name="smoking" size={16} color="green" />
